    ...
    const geometries = [
        {
            position: [0, 0, 0],
            r: 0.3,
            geometry: new THREE.IcosahedronGeometry(3), // 20 faces Gem
        },
        {
            position: [1, -0.75, 4],
            r: 0.4,
...
function Geometry({r, position, geometry, materials, soundEffect}) {
    ...
    function handleClick(e) {
        ...
        mesh.materials = getRandomMaterial(); // Not call so no color change
