...
type BlogPostDocumentDataSlicesSlice = ImageBlockSlice | TestBlockSlice;
...
type ProjectDocumentDataSlicesSlice = ImageBlockSlice | TestBlockSlice;
...
export interface ExperienceSliceDefaultPrimaryExperiencesItem {
  ...
  /**
   * Time span field in *Experience → Default → Primary → experiences*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.experiences[].time_span
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  time_span: prismic.KeyTextField;
...
export interface TestBlockSliceDefaultPrimary {
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: test_block.default.primary.text
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
